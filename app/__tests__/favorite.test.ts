...
describe('favorite api', () => {
  it('gets user favorites', async () => {
    const testUserId = '75a16b5d-14fd-4ca8-9af8-b8d0164e7c88';
    ...
    expect(favoriteRes.body.length).to.be.greaterThan(0);

    const sampleFavorite = favoriteRes.body[0];
    ...
    expect(sampleFavorite.userId).to.equal(testUserId);
  });
